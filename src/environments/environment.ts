...
export const environment = {
  ...
  v1ApiEndPointWS: 'ws://192.168.68.114:4200/api/v1/',*/
  v1AuthEndpoint: 'http://192.168.0.104:8085/api/v1/',
  v1ApiEndPoint: 'http://192.168.0.104:8080/api/v1/',
  v1ApiEndPointWS: 'ws://192.168.0.104:8080/api/v1/',
}
