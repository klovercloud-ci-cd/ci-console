...
export class RoleService {
  ...
  getRole(roleId: string): Observable<any> {
    return this.http.get(environment.v1AuthEndpoint +  endpoints.ROLES + '/' + roleId)
  }
  createRole(payload: any): Observable<any> {
    ...
    return this.http.post(environment.v1AuthEndpoint +  endpoints.ROLES, payload, httpOptions)
  }
  updateRole(roleId: string, payload: any): Observable<any> {
    return this.http.put(environment.v1AuthEndpoint +  endpoints.ROLES + '/' + roleId, payload)
  }
  deleteRole(role: any): Observable<any> {
    return this.http.delete(environment.v1AuthEndpoint +  endpoints.ROLES + '/' + role?.name)
  }
