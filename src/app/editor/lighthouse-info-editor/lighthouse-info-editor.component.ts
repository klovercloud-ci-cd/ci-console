...
@Component({
  selector: 'kcci-lighthouse-info-editor',
  templateUrl: './lighthouse-info-editor.component.html',
  styleUrls: ['./lighthouse-info-editor.component.scss']
})
export class LighthouseInfoEditorComponent  implements  OnInit, AfterViewInit, OnChanges {
